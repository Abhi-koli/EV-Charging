			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"evcharger-display": {
								"semanticObject": "evcharger",
								"action": "display",
								"description": "An SAP Fiori application to find Ev charging stations.",
								"title": "EV Station Finder",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=evcharger",
									"url": sap.ui.require.toUrl("evcharger")
								}
							}
						}
					}
